  ...
  project: [
    {
      ...
      alert: 'I finally upgraded the website build system, this version of the website is generated by the new code, there maybe some tiny little bugs, I will chase them all. I won\'t keep the changelog anymore as the video chapters are now sorted newest-first.',
...

    {
      ...
      alert: 'I finally upgraded the website build system, this version of the website is generated by the new code, there maybe some tiny little bugs, I will chase them all. This upgrade will bring support for more books, and a more portable database that can last. Apologies, if there are some hiccups or slight publishing delays in the next few days.',
      icon: "earbuds",
      order: "latest",
